...
$(document).ready(function(){
	...
	$('<link>').appendTo('head').attr({
		type: 'text/css', 
		rel: 'stylesheet',
		href: 'static/assets/css/light.css'
	});
	if (localStorage.theme == "dark") {
		// Handle menu
		$("link[href='static/assets/css/light.css']").remove();
		$('<link>').appendTo('head').attr({
			type: 'text/css', 
			rel: 'stylesheet',
			href: 'static/assets/css/dark.css'
		});
		$('#theme').empty().append("<i class='fa-duotone fa-lightbulb-slash'></i>");
	}
	// Done because light is the one by default
	if(localStorage.lan == "es") {
		$('#lan img').attr("src","static/assets/img/es_flag.webp");
		$('#lan').addClass("es");
	}
	updateLanguage();
	...
	*/
	...
	$('#theme').click(function(e) {
		if(localStorage.theme != "dark"){
			...
			$("link[href='static/assets/css/dark.css']").remove();
			$('<link>').appendTo('head').attr({
				type: 'text/css', 
				rel: 'stylesheet',
				href: 'static/assets/css/light.css'
	...
	$('#lan').click(function(e) {
		if(!$(e.currentTarget).hasClass('es')){
			...
			$('#lan img').attr("src","static/assets/img/en_flag.webp");
